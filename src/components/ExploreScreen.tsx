  ...
  return (
    <div className="mb-7">
      ...
      <div className="relative group/row">
          ...
          {/* Scrollable cards */}
          <div ref={scrollRef} className="flex gap-2.5 overflow-x-auto snap-x snap-mandatory hide-scrollbar pb-1">
            {creatives.map((c) =>
  ...
  return (
    <>
      ...
      <div className="sticky top-[52px] z-[90] backdrop-blur-md">
        ...
        <div className="flex items-center md:px-6 py-2.5 border-b border-border bg-card/95 px-[16px] gap-0">

          {/* Scrollable pills — text only, no icons */}
          <div className="flex-1 min-w-0 relative">
            <div className="overflow-x-auto hide-scrollbar pr-1 flex items-center justify-center gap-[3px]">
              {categories.map((f) => {
