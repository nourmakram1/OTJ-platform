...
const ProjectProfile = () => {
  ...
  const { userRole, getProject, submitProposal, addMeeting, addAttachment, removeAttachment, renameAttachment, completeProject, addReview, clients, confirmPaymentReceipt, setPhaseReady } = useProjects();
