...
export interface AmendRequest {
  ...
  note: string;
  /** Optional deadline the client suggested when raising the amend. Non-binding — the creative confirms the actual deadline. */
...
// Mock bank-transfer screenshot used to demo the Download flow on completed projects.
const MOCK_BANK_PROOF = "data:image/svg+xml;utf8," + encodeURIComponent(`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 280'><rect width='400' height='280' fill='%23f4f6f8'/><rect x='16' y='16' width='368' height='248' rx='14' fill='white' stroke='%23e3e6ea' stroke-width='1.5'/><rect x='32' y='34' width='120' height='14' rx='4' fill='%2316a34a'/><text x='32' y='80' font-family='Inter, sans-serif' font-size='13' font-weight='700' fill='%230f172a'>Transfer Successful</text><text x='32' y='104' font-family='Inter, sans-serif' font-size='11' fill='%2364748b'>Reference: TXN-9028471</text><line x1='32' y1='118' x2='368' y2='118' stroke='%23e3e6ea'/><text x='32' y='142' font-family='Inter, sans-serif' font-size='10' fill='%2364748b'>Amount</text><text x='32' y='162' font-family='Inter, sans-serif' font-size='18' font-weight='800' fill='%230f172a'>1,750.00 EGP</text><text x='32' y='192' font-family='Inter, sans-serif' font-size='10' fill='%2364748b'>To · @nour.creative (InstaPay)</text><text x='32' y='210' font-family='Inter, sans-serif' font-size='10' fill='%2364748b'>From · Edita Group</text><text x='32' y='244' font-family='Inter, sans-serif' font-size='10' fill='%2394a3b8'>Generated by your bank app — sample for demo</text></svg>`);
...
const defaultCompleted: CompletedProjectData[] = [
  {
    ...
    paymentMilestones: [
      { label: '50% Deposit', percentage: 50, status: 'paid', paidAt: 'Jan 15, 2026 · 10:24', proofUrl: MOCK_BANK_PROOF, proofName: 'pepsi-deposit-transfer.jpg' },
      { label: '50% On Completion', percentage: 50, status: 'paid', paidAt: 'Feb 10, 2026 · 17:48', proofUrl: MOCK_BANK_PROOF, proofName: 'pepsi-final-transfer.jpg' },
    ],
  ...
  },
  {
    ...
    paymentMilestones: [
      { label: '30% Deposit', percentage: 30, status: 'paid', paidAt: 'Jan 5, 2026 · 09:12', proofUrl: MOCK_BANK_PROOF, proofName: 'oppo-deposit.jpg' },
      { label: '40% On Rough Cut', percentage: 40, status: 'paid', paidAt: 'Jan 26, 2026 · 15:30', proofUrl: MOCK_BANK_PROOF, proofName: 'oppo-rough-cut.jpg' },
      { label: '30% Final Delivery', percentage: 30, status: 'paid', paidAt: 'Feb 2, 2026 · 18:05', proofUrl: MOCK_BANK_PROOF, proofName: 'oppo-final.jpg' },
    ],
